(function jvxPixelWrapper(){
    ...
    var isDebug = false;
    var existingData = ["RecentVisitor"];
    var existingGroups = {"group4":["cat_na","footwear"],"group3":["RecentVisitor"],"group6":["TopProducts_na","women","men"],"group5":["sugProducts_na"],"group2":["12272817","11973147","12009822"],"group1":["product_na","12087139","11973147"]};
    var pixelParams = {"px":"7591cc2559e0c9"};
    var addnlPixelData = function getRetargetingData() {
   // refer to help link for more options
 return   ["RecentVisitor"];
 };
    var partnerSyncPixels = {"krux":"//sync.jivox.com/tags/sync/usync.php?px=eZQcCLxB&src=re&id=7591cc2559e0c9"};
