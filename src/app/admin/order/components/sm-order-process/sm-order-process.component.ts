...
@Component({
  ...
  templateUrl: './sm-order-process.component.html',
  styleUrls: ['./sm-order-process.component.css']
})
export class SMOrderProcessComponent implements OnInit {
  ...
  constructor(private dialogRef: MatDialogRef<SMOrderProcessComponent>,
